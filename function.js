...
function hitungharga() {
  if (kategori.value == 'Nissan March AT') {
    hargasewa = 300000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargasewa;
  } else if (kategori.value == 'Avanza MT') {
    hargasewa = 350000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargasewa;
  } else if (kategori.value == 'Toyota Sienta AT') {
    hargasewa = 450000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargasewa;
  } else if (kategori.value == 'Innova Reborn MT/AT') {
    hargasewa = 500000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargasewa;
  } else if (kategori.value == 'Fortuner VRZ') {
    hargasewa = 1000000;
    jumlahukuran = ukuran.value;

    harga.value = jumlahukuran * hargasewa;
  } else if (kategori.value == 'Pajero Dakkar') {
    hargasewa = 1200000;
    jumlahukuran = ukuran.value;
